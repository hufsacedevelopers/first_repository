...
현재 MVP 1차 운영 범위는 **경기도 중심**으로 설정하여 사용자 여정 검증에 집중하고 있습니다.

경기도부터 시작하는 이유:
- 경기도는 청년 인구와 기업 수가 모두 큰 지역이어서 초기 사용자 수요와 기업 추천 로직을 함께 검증하기에 적합합니다.
- 시군별 산업 구조와 고용 환경의 차이가 커, 하나의 권역 안에서도 다양한 사용자 여정을 테스트할 수 있습니다.
- 등록장애인 및 관련 공공데이터가 비교적 잘 축적되어 있어, 장애 친화도 점수 산정과 정책 정보 연결의 정확도를 높이기 좋습니다.
- 따라서 경기도를 MVP의 시작점으로 삼아 서비스 완성도와 데이터 신뢰도를 확보한 뒤 수도권·전국 확장을 추진합니다.
